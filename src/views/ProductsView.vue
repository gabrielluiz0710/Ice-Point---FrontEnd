...
const products = ref([
  ...
  // PICOLÉ DE LEITE
  { id: 32, name: 'Açaí', category: 'picole-leite', type: 'image', src: '/sabores/images/picole-leite/acai.png' },
  { id: 33, name: 'Abacate', category: 'picole-leite', type: 'icon', iconClass: 'custom-popsicle' },
  { id: 34, name: 'Abacaxi Suíço', category: 'picole-leite', type: 'image', src: '/sabores/images/picole-leite/abacaxisuico.png' },
  { id: 35, name: 'Ameixa', category: 'picole-leite', type: 'image', src: '/sabores/images/picole-leite/ameixa.png' },
  { id: 36, name: 'Amendoim', category: 'picole-leite', type: 'image', src: '/sabores/images/picole-leite/amendoim.png' },
  { id: 37, name: 'Banana', category: 'picole-leite', type: 'image', src: '/sabores/images/picole-leite/banana.png' },
  { id: 38, name: 'Blue Ice', category: 'picole-leite', type: 'image', src: '/sabores/images/picole-leite/blueice.png' },
  ...
  { id: 42, name: 'Chocolate', category: 'picole-leite', type: 'image', src: '/sabores/images/picole-leite/chocolate.png' },
  ...
  { id: 47, name: 'Coco', category: 'picole-leite', type: 'image', src: '/sabores/images/picole-leite/coco.png' },
  { id: 48, name: 'Coco Queimado', category: 'picole-leite', type: 'image', src: '/sabores/images/picole-leite/cocoqueimado.png' },
  { id: 49, name: 'Creme', category: 'picole-leite', type: 'image', src: '/sabores/images/picole-leite/creme.png' },
  { id: 50, name: 'Cupuaçu', category: 'picole-leite', type: 'image', src: '/sabores/images/picole-leite/cupuacu.png' },
  ...
  { id: 53, name: 'Goiaba', category: 'picole-leite', type: 'image', src: '/sabores/images/picole-leite/goiaba.png' },
  { id: 54, name: 'Iogurte com Morango', category: 'picole-leite', type: 'image', src: '/sabores/images/picole-leite/iogurtemorango.png' },
  { id: 55, name: 'Kiwi', category: 'picole-leite', type: 'icon', iconClass: 'custom-popsicle' },
  { id: 56, name: 'Leite Condensado', category: 'picole-leite', type: 'image', src: '/sabores/images/picole-leite/leitecondensado.png' },
  { id: 57, name: 'Leite Ninho', category: 'picole-leite', type: 'icon', iconClass: 'custom-popsicle' },
  { id: 58, name: 'Limão Suíço', category: 'picole-leite', type: 'image', src: '/sabores/images/picole-leite/limaosuico.png' },
  { id: 59, name: 'Maracujá', category: 'picole-leite', type: 'icon', iconClass: 'custom-popsicle' },
  { id: 60, name: 'Milho Verde', category: 'picole-leite', type: 'image', src: '/sabores/images/picole-leite/milho.png' },
  { id: 61, name: 'Morango', category: 'picole-leite', type: 'image', src: '/sabores/images/picole-leite/morangoleite.png' },
  ...
  // PICOLÉ DE FRUTA
  { id: 65, name: 'Abacaxi', category: 'picole-fruta', type: 'image', src: '/sabores/images/picole-fruta/abacaxi.png' },
  ...
  { id: 87, name: 'Leite Condensado', category: 'ituzinho', type: 'image', src: '/sabores/images/picole-ituzinho/ituleitecondensado.png' },
  { id: 88, name: 'Limão', category: 'ituzinho', type: 'icon', iconClass: 'ituzinho-icon' },
  { id: 89, name: 'Maracujá', category: 'ituzinho', type: 'image', src: '/sabores/images/picole-ituzinho/itumaracuja.png' },
  ...
  { id: 92, name: 'Brigadeiro', category: 'skimo', type: 'image', src: '/sabores/images/picole-skimo/brigadeiro.png' },
  { id: 93, name: 'Coco', category: 'skimo', type: 'icon', iconClass: 'skimo-icon' },
  { id: 94, name: 'Tentação', category: 'skimo', type: 'image', src: '/sabores/images/picole-skimo/tentacao.png' },
]);
